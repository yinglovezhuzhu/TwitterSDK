...
import com.owen.twitter.sdk.utils.UrlUtils;
...
class OAuth1aParameters {
    ...
    private final TwitterAccessToken authToken;
    private final String callback;
    private final String method;
    private final String url;
    private final Map<String, String> postParams;

    OAuth1aParameters(TwitterAuthConfig authConfig, TwitterAccessToken authToken,
    ...
    String calculateSignature(String signatureBase) {
        try {
            ...
            LogUtils.e("Failed to calculate signature: " + LogUtils.getStackTrace(e));
            return "";
